                ...
                {!userInput ? 
                    ...
                    <ModalFooter>
                        ...
                        >
                            ...
                            <Flex gap='8px'>
                                <PrimaryButton innerText='Yes' handleButtonClick={handleInteraction}/>
                                <SecondaryButton innerText='No' handleButtonClick={handleInteraction}/>
                            </Flex> 
                        </Flex>
                    </ModalFooter>
                    :
                    <ModalFooter>
                        <Text>Within the past 10 min, 80% of users are experiencing delays</Text>
